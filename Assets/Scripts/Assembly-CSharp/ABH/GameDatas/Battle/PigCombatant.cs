...
namespace ABH.GameDatas.Battle
{
	public class PigCombatant : BaseCombatant<PigGameData>
	{
		...
		public override void RaiseCombatantDefeated()
		{
			...
			DIContainerLogic.GetBattleService().LogDebug("Pig defeated: " + Model.BalancingData.NameId, BattleLogTypes.Pig);
		}
		...
		public override void RaiseCombatantKnockedOut()
		{
			...
			DIContainerLogic.GetBattleService().LogDebug("Pig knocked out: " + Model.BalancingData.NameId, BattleLogTypes.Pig);
		}
